...
void loop() {
  ...
  switch(mode){
    ...
    case 5: alternatingRapid(); break;//a bit  detlay 250 or 500 ms
    case 6: progressiveSweep(); break;
    case 7: pursuitChase(); break;
    case 8: fullStrobe(); break; // delay 500ms
  }
}
...
// 1 – Single
void lightbarSingle(){
  redSide(); delay(120); allOff(); delay(80);
  blueSide(); delay(120); allOff(); delay(80);
}

// 2 – Double
void lightbarDouble(){
  for(int i=0;i<2;i++){
    redSide(); delay(100); allOff(); delay(70);
  }
  for(int i=0;i<2;i++){
    blueSide(); delay(100); allOff(); delay(70);
  }
}
...
void lightbarTriple(){
  for(int i=0;i<3;i++){
    redSide(); delay(90); allOff(); delay(60);
  }
  for(int i=0;i<3;i++){
    blueSide(); delay(90); allOff(); delay(60);
  }
}
